...
namespace WebApplication4.Controllers
{
    ...
    public class KullanicisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "No,TcKimlikNo,Ad,Soyad,DogumTarihi,KayitTarihi")] Kullanici kullanici)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "No,TcKimlikNo,Ad,Soyad,DogumTarihi,KayitTarihi")] Kullanici kullanici)
        {
            if (ModelState.IsValid)
            {
